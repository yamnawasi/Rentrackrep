<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddArea.aspx.cs" Inherits="AddArea" %>
...
<head runat="server">
    ...
    <script>
        /*function isLetterKey(evt)
        {
            ...
            if ((charCode >= 65 && charCode <= 90) || (charCode >= 97 && charCode <= 122) || charCode == 45 || charCode == 32 || charCode == 47)
                return true;    
             return false;
        }*/
        ...
        <div class="container-fluid" id="bigdiv">
            ...
            <div class="tab-content">
                ...
                <asp:Panel ID="addrow" runat="server" CssClass="tab-pane container active col-12">
                    ...
                    <!--Area-->
                    <label class="form-label">Area<span class="required-sign"> *</span></label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="This field is required" CssClass="text-danger error-design" ControlToValidate="tbarea" validationgroup="Addareafields"></asp:RequiredFieldValidator> 
                        <asp:TextBox ID="tbarea" runat="server" class="form-control narrower"></asp:TextBox>    
                    <br />
                ...
                <asp:Panel ID="remrow" runat="server" CssClass="tab-pane container fade col-12">
                    ...
                    <label class="form-label">Area ID<span class="required-sign"> *</span></label>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidatortbcityid" runat="server" ErrorMessage="This field is required" CssClass="text-danger error-design" ControlToValidate="tbareaid" validationgroup="Remareafields"></asp:RequiredFieldValidator>
                         <asp:TextBox ID="tbareaid" runat="server" class="form-control narrower" onkeypress="return isNumberKey(event)"></asp:TextBox>                    
                    <br />
                    <div style="text-align: center">
            ...
            <div id="tablediv" runat="server">
                ...
                <div class="container" id="tableheadingdiv">
                  <h3 class="pageheadings" id="tableheading">Area Table</h3>
                </div>
